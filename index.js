...
client.on('messageCreate', (message) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (message.channelId.toString() === memeChannel && !message.author.bot) {
        ...
        else if (!((_f = message.member) === null || _f === void 0 ? void 0 : _f.permissions.has('MANAGE_MESSAGES'))) {
    ...
    if (!message.content.startsWith(prefix) || message.author.bot)
        return;
    if (command === 'ping' && ((_g = message.member) === null || _g === void 0 ? void 0 : _g.permissions.has('MANAGE_MESSAGES', true)) && !args[0]) {
        message.reply('Calculating latency...').then(resultMessage => {
            const ping = resultMessage.createdTimestamp - message.createdTimestamp;
            resultMessage.edit(`Bot latency: ${ping}ms\nAPI Latency: ${client.ws.ping}ms`);
        });
    }
    else if (command === 'ping' && !((_h = message.member) === null || _h === void 0 ? void 0 : _h.permissions.has('MANAGE_MESSAGES', true))) {
        message.channel.send('Insufficient permissions, `Manage Messages` required!');
    }
    if (command === 'setmc' && ((_j = message.member) === null || _j === void 0 ? void 0 : _j.permissions.has('MANAGE_MESSAGES', true))) {
        if (!message.mentions.channels.first() || !args[0]) {
            message.channel.send('Please mention a channel!');
        }
        else if (args[0] !== ((_k = message.mentions.channels.first()) === null || _k === void 0 ? void 0 : _k.toString())) {
            message.channel.send('Please enter valid syntax!');
        }
        else if (((_l = message.mentions.channels.first()) === null || _l === void 0 ? void 0 : _l.id) === memeChannel) {
            message.channel.send('This has already been set!');
        }
        else if (args[0] === ((_m = message.mentions.channels.first()) === null || _m === void 0 ? void 0 : _m.toString())) {
            setValue((_o = message.mentions.channels.first()) === null || _o === void 0 ? void 0 : _o.id);
            message.channel.send(`Successfully set meme channel to <#${memeChannel}>`);
        }
    }
    else if (command === 'setmc' && !((_p = message.member) === null || _p === void 0 ? void 0 : _p.permissions.has('MANAGE_MESSAGES', true))) {
        message.channel.send('Insufficient permissions, `Manage Messages` required!');
    }
    if (command === 'start' && ((_q = message.member) === null || _q === void 0 ? void 0 : _q.permissions.has('MANAGE_MESSAGES', true)) && !args[0] && message.channelId.toString() === memeChannel) {
    ...
    else if (command === 'start' && !((_t = message.member) === null || _t === void 0 ? void 0 : _t.permissions.has('MANAGE_MESSAGES', true)) && !args[0] && message.channelId.toString() !== memeChannel) {
        message.channel.send('Insufficient permissions, `Manage Messages` required!');
    }
    if (command === 'stop' && ((_u = message.member) === null || _u === void 0 ? void 0 : _u.permissions.has('MANAGE_MESSAGES', true)) && !args[0] && message.channelId.toString() === memeChannel) {
            ...
            for (let [winnerKey, winnerMsg] of msgArr) {
                if (winnerMsg.reactions.cache.get(emojiID)) {
                    ...
                    if (winnerMsg.reactions.cache.get(emojiID).count === winner) {
                        ...
                        winningMeme = (_v = winnerMsg.attachments.first()) === null || _v === void 0 ? void 0 : _v.url;
                    }
                }
            }
    ...
    else if (command === 'stop' && ((_x = message.member) === null || _x === void 0 ? void 0 : _x.permissions.has('MANAGE_MESSAGES', true)) && !args[0] && message.channelId.toString() !== memeChannel) {
        message.channel.send(`Cannot stop here because meme channel is set to <#${memeChannel}>.`);
    }
    else if (command === 'stop' && !((_y = message.member) === null || _y === void 0 ? void 0 : _y.permissions.has('MANAGE_MESSAGES', true)) && !args[0] && message.channelId.toString() !== memeChannel) {
        message.channel.send('Insufficient permissions, `Manage Messages` required!');
    }
    if (command === 'help' && ((_z = message.member) === null || _z === void 0 ? void 0 : _z.permissions.has('MANAGE_MESSAGES', true)) && !args[0]) {
    ...
    else if (command === 'help' && !((_0 = message.member) === null || _0 === void 0 ? void 0 : _0.permissions.has('MANAGE_MESSAGES', true)) && !args[0]) {
        message.channel.send('Insufficient permissions, `Manage Messages` required!');
    }
}));
